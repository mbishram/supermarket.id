  ...
  <div class="container">
    <div class="col-md-4 products-left">
      <div class="categories">
        <h2>Categories</h2>
        <ul class="cate">
          <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Buah dan Sayu</a></li>
            <ul>
              ...
              <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Sayuran Segar</a> </li>
              <!--<li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>International Vegetables</a> </li> -->
              <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Sayuran dan Buah Organik</a></li>
            </ul>
          <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Bahan Makanan</a></li>
            <ul>
              <!-- <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Dals & Pulses</a> </li> -->
              <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Buah Basah</a> </li>
              <!-- <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Edible Oils & Ghee</a> </li> -->
              <!-- <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Tepung dan Sooji</a> </li> 
              ...
              <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Beras</a> </li>
              <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Garam, Gula dan Bumbu Dapur</a></li>
            </ul>
          <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Perawatan Pribadi</a></li>
            <ul>
              <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Bayi</a> </li>
              <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Kosmetik</a> </li>
              <li><a href="products"><i class="fa fa-arrow-right" aria-hidden="true"></i>Parfume</a> </li>
